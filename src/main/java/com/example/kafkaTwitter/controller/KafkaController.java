...
import com.example.kafkaTwitter.service.Producer;
...
public class KafkaController {
	...
	public void sendMessage(@RequestParam("value") String value, @RequestParam("tag") String tag) throws IOException, URISyntaxException {
		...
		String bearerToken = "AAAAAAAAAAAAAAAAAAAAAEFYWQEAAAAAprA9Z7S0tmDiIe3ALzaOA%2Bgre%2Bc%3DiWfXZtQJOlEEt6GSC59SN1PZhKXWmB8M7ChdCRNWs8hzbXjOxp";
	    if (null != bearerToken) {
	      Map<String, String> rules = new HashMap<>();
//	      rules.put("cats has:images", "cat images");
//	      rules.put("dogs has:images", "dog images");
//	      rules.put("Covid19", "Covid19");
	      rules.put(value, tag);
